...
const SectionTitle = ({ subTitle, title, paragraph, icon = '/images/hero/icon-title.svg' }: propsType) => {
  return (
    <div className="wow fadeInUp mb-16 text-center relative z-10">
      ...
      <h2 className="text-white mb-4.5 text-2xl font-extrabold sm:text-4xl xl:text-heading-2">{title}</h2>
