  ...
  return (
    <div className="relative aiExamples-border-gredient rounded-lg">
      <div className="group relative overflow-hidden py-9 px-8 rounded-lg ">
        <span
          className={`features-bg absolute w-full h-full left-0 top-0 -z-1 ${example?.rotate && 'rotate-180'}`}
        ></span>
        ...
        <h4 className="font-semibold text-2xl text-white mb-4">{example.title}</h4>
