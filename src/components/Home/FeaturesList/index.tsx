                  ...
                  <div className="flex items-center justify-between relative z-20">
                    <div className="max-w-[477px] w-full">
                      <span className="hero-subtitle-gradient relative mb-4 font-medium text-sm inline-flex items-center gap-2 py-2 px-4.5 rounded-full">
                        ...
                        <span className="hero-subtitle-text">Kickstart your AI Startup</span>
                      </span>
                      <h3 className="text-white mb-4.5 font-bold text-heading-4">Seamless OpenAI Integration</h3>
                    ...
                    <div className="max-w-[428px] relative aspect-square w-full hidden sm:block">
                      <Image src="/images/features/big-icon.svg" alt="icon" fill />
                    </div>
                  </div>
              ...
              <div className="relative rounded-3xl features-box-border">
                <div className="relative overflow-hidden rounded-3xl px-11 pt-12.5 pb-14 box-hover box-hover-small">
                  <div className="relative z-20">
                    ...
                    <h3 className="text-white mb-4.5 font-semibold text-heading-6">All Essential SaaS Pages</h3>
                    <p className="font-medium">
                      Build SaaS AI applications using OpenAI and Next.js, this kit comes with pre-configured and
                      pre-built examples, making it easier to quickly kickstart.
                    </p>
                  </div>
              ...
              <div className="relative rounded-3xl features-box-border">
                <div className="relative overflow-hidden rounded-3xl px-11 pt-12.5 pb-14 box-hover box-hover-small">
                  <div className="relative z-20">
                    ...
                    <h3 className="text-white mb-4.5 font-semibold text-heading-6">Highly Customizable</h3>
                    <p className="font-medium">
