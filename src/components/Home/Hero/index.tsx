...
const Hero = () => {
  return (
    <section id="home" className="relative overflow-hidden z-10 pt-35 md:pt-40 xl:pt-45">
      ...
      <div className="mx-auto max-w-[900px] px-4 sm:px-8 xl:px-0 relative z-1">
        <div className="text-center">
          <span className="hero-subtitle-gradient hover:hero-subtitle-hover relative mb-5 font-medium text-sm inline-flex items-center gap-2 py-2 px-4.5 rounded-full">
            ...
            <span className="hero-subtitle-text">Start your AI Journey here</span>
          </span>
      ...
      <div className="mt-17 aspect-[1170/411] relative max-w-[1170px] w-full mx-auto" data-wow-delay="0.1s">
