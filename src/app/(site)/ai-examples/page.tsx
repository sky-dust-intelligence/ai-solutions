    ...
    <>
      ...
      <section className="pt-3 pb-25">
        <div className="max-w-[1170px] mx-auto px-4 sm:px-8 xl:px-0 z-10">
          <div className="bg-white/[0.05] relative aiExamples-border-gradient rounded-lg lg:py-2 lg:px-6 p-4 flex justify-center md:justify-between flex-col lg:flex-row items-center">
            <p className="text-center md:text-left">
              ...
              />
              Note: You need to add an OpenAI API key to try example demos, on production you can add it on .env
            </p>
            <button
